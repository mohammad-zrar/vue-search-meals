<template>
  <div class="w-[100%] md:w-[82%] lg:w-[60%] mx-auto p-8 sm:p-2 text-clip">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2">
      ...
      <div class="mt-5 mb-10 flex">
        ...
        <a
          :href="meal.strSource"
          target="_blank"
          class="px-3 py-2 rounded border-2 whitespace-nowrap border-transparent font-semibold border-indigo-600 text-indigo-600 ml-3 hover:text-indigo-100 hover:bg-indigo-600 transition-colors"
        >
